  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 150 }}>
        ...
        <Field label="Flat, house, etc. (optional)">
        ...
        <Field label="District/locality (optional)">
          <TextInput style={styles.inputBase} onChangeText={(v) => update("area", v)} />
        </Field>
