...
export default function Location() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.sectionTitle}>Where is your stay located?</Text>
      <Text style={styles.subLabel}>
        For privacy, address is shared only with booked guests.
      </Text>
      ...
      <AddressSelector
        ...
        onPress={() =>
          router.push({
            pathname: "/become-host/address/address",
      ...
      <StepProgress active={3} total={12} />

      {/* ✅ Disable Next until address is filled */}
      <StepFooter
        onBack={() => router.push("/become-host/about")}
        onNext={() => router.push("/become-host/step2")}
